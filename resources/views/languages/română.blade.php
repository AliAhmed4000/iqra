            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-10">
                     <form id="form_aside">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" id="" placeholder="Numele Complet *">
                        </div>
                        <div class="mb-3">
                            <input type="email" class="form-control" id="" placeholder="E-mail *">
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control" id="" placeholder="Telefon *">
                        </div>
                        <div class="mb-2">
                            <input type="file" class="form-control file_ch_box" id="">
                        </div>
                        <div class="mb-1">
                            <p class="ad_more_f"><i class="fa fa-plus"></i>  Adăugați mai multe fișiere</p>
                        </div>
                        <div class="mb-3">
                            <textarea class="form-control" placeholder="Notițe" rows="5"></textarea>
                        </div>
                        <div class="mb-2">
                            <button type="submit" class="btn btn-primary btn__submit">Trimite</button>
                        </div>
                        <div class="mb-1">
                            <a href="#"><button class="btn btn-primary btn__r_quote">sau solicitați o <br> ofertă <br>detaliată de preț</button></a>
                        </div>
                    </form>
